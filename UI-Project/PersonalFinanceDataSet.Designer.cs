...
SELECT CLIENT_ID, CLIENT_EGN, CLIENT_NAME, CLIENT_SURNAME, CLIENT_LASTNAME, CLIENT_EMAIL, CLIENT_PHONE FROM CLIENT WHERE (CLIENT_ID = @CLIENT_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT CLIENT_ID, CLIENT_EGN, CLIENT_NAME, CLIENT_SURNAME, CLIENT_LASTNAME, CLIEN" +
                "T_EMAIL, CLIENT_PHONE FROM dbo.CLIENT WHERE  @row LIKE @value";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@row", global::System.Data.SqlDbType.VarChar, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].CommandText = "SELECT CLIENT_ID, CLIENT_EGN, CLIENT_NAME, CLIENT_SURNAME, CLIENT_LASTNAME, CLIEN" +
                "T_EMAIL, CLIENT_PHONE FROM dbo.CLIENT WHERE @row  LIKE \'ss\'";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@row", global::System.Data.SqlDbType.VarChar, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillBy(PersonalFinanceDataSet.CLIENTDataTable dataTable, string row, string value) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((row == null)) {
                throw new global::System.ArgumentNullException("row");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(row));
            }
            if ((value == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillDataFromSearch(PersonalFinanceDataSet.CLIENTDataTable dataTable, string row) {
        ...
        public virtual PersonalFinanceDataSet.CLIENTDataTable GetDataBySearch(string row) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((row == null)) {
                throw new global::System.ArgumentNullException("row");
            }
...
SELECT DOSSIER_NO, CLIENT_ID, DOSSIER_YEAR, DOSSIER_STATUS, DOSSIER_MIN_BALANCE FROM DOSSIER WHERE (DOSSIER_NO = @DOSSIER_NO)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT DOSSIER_NO, CLIENT_ID, DOSSIER_YEAR, DOSSIER_STATUS, DOSSIER_MIN_BALANCE F" +
                "ROM dbo.DOSSIER WHERE @row = @value";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@row", global::System.Data.SqlDbType.VarChar, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@value", global::System.Data.SqlDbType.VarChar, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual PersonalFinanceDataSet.DOSSIERDataTable GetDataBySearch(string row, string value) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((row == null)) {
                throw new global::System.ArgumentNullException("row");
            }
...
SELECT DD_ID, DOSSIER_NO, INCEXP_ID, DD_DATE, DD_VALUE, DD_DOC FROM DOSSIER_DETAILS WHERE (DD_ID = @DD_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT DD_ID, DOSSIER_NO, INCEXP_ID, DD_DATE, DD_VALUE, DD_DOC FROM dbo.DOSSIER_D" +
                "ETAILS WHERE @row = @value";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@row", global::System.Data.SqlDbType.VarChar, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@value", global::System.Data.SqlDbType.VarChar, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual PersonalFinanceDataSet.DOSSIER_DETAILSDataTable GetDataBy(string row, string value) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((row == null)) {
                throw new global::System.ArgumentNullException("row");
            }
